...
class PlanCalendarFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.textCalendarTitle.setText(R.string.calendar_plan_title)
    ...
    private fun renderSelectedDateItems() {
        val selectedItems = plans.filter { plan ->
            isDateIncluded(plan.planDate, selectedDate)
        }
        ...
        binding.textCalendarItems.text = if (selectedItems.isEmpty()) {
            ...
            val itemText = selectedItems.joinToString("\n\n") { plan ->
                "제목: ${plan.place}\n날짜: ${plan.planDate}\n메모: ${plan.memo ?: getString(R.string.item_no_memo)}"
            }
    ...
    private fun makeEventDateSet(): HashSet<String> {
        ...
        plans.forEach { plan ->
            addDateRangeToSet(result, plan.planDate)
        }
